"""Talk to your Placement Assistant in the terminal. (Given.)
    ...
    python -m scripts.chat                           # real Groq (needs GROQ_API_KEY)
...
from app.providers import AgentError, default_mock, default_provider
...
def main() -> None:
    ...
    provider = default_mock() if a.mock else default_provider(os.environ.get("GROQ_MODEL") or "llama-3.3-70b-versatile")
